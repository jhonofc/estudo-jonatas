...
let textTwo = 'hello ';
let textTwoS = 'hello world';
let text = textTwo + textTwoS 
console.log(text);
console.log("********************************************")
...
const numTwelve = 12;
const numThirteen = 13;
const numFourtheen = 14;
...
const numSeventheen = 50;
const numEighteen = 22;
const numNinetheen = 04;
...
const numTwentyTwo = 4;
const numTwentyThree = 6;
...
const dif = numTwentyFour - numTwentyFive;
console.log(dif != 5);
console.log("*********************************************")
